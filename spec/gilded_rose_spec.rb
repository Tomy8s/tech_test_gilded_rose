...
describe GildedRose do
  let (:items) { [
    Item.new(name="+5 Dexterity Vest", sell_in=2, quality=25),
    Item.new(name="Elixir of the Mongoose", sell_in=2, quality=25),
    Item.new(name="Aged Brie", sell_in=2, quality=25),
    Item.new(name="Sulfuras, Hand of Ragnaros", sell_in=2, quality=25),
    Item.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=15, quality=25),
    Item.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=10, quality=25),
    Item.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=5, quality=25),
